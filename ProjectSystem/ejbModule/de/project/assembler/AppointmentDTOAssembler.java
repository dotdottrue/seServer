...
public class AppointmentDTOAssembler {
	...
	public AppointmentTO makeDTO(Appointment appointment) {
		...
		dto.setShortNote(noteDtoAssembler.makeDTO(appointment.getShortNote()));
		dto.setTopic(appointment.getTopic());
		dto.setUsers(makeDTO(appointment.getUsers(), dto));
		
		return dto;
	}
	
	private List<UserTO> makeDTO(List<User> users, AppointmentTO dto2) {
