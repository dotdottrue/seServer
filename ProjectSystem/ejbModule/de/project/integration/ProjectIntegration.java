...
public class ProjectIntegration {
	 ...
	 * @param phoneNumber = Uebergabeparameter Telefonnummer f�r den zu speichernden Benutzer.
	...
	/**
	 * Diese Methode/Schnittstelle f�hrt ein Projektupdate vor.
	 ...
	 * @param description = Eine Neue Projektdeskripion die aktualisiert werden w�rde.
